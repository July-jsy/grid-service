...
public class DataStore {
    ...
    private void seedData() {
        ...
        grids.add(new Grid(nextGridId(), "WG-001", "春风里第一网格", "春风里社区",
                "覆盖春风路1-8号楼", "张晓梅", "138****1201", 1260, 116.397428, 39.909204, null));
        grids.add(new Grid(nextGridId(), "WG-002", "春风里第二网格", "春风里社区",
                "覆盖春风路9-16号楼", "李建国", "138****1202", 980, 116.403428, 39.915204, null));
        grids.add(new Grid(nextGridId(), "WG-003", "幸福家园网格", "幸福家园社区",
                "幸福家园小区全域", "王芳", "138****1203", 1530, 116.410428, 39.920204, null));
